...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject passes a block to each element, returns the value to sum, and carries over the sum variable to the next iteration. The final returned value is the accumulation of the results of the block from each element.
  end
