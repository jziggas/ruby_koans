...
class AboutSymbols < EdgeCase::Koan
  ...
  # A: To compare symbol names and not object identities
  ...
  # A: http://stackoverflow.com/questions/4573991/why-is-it-not-a-good-idea-to-dynamically-create-a-lot-of-symbols-in-ruby
