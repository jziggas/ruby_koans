...
class AboutHashes < EdgeCase::Koan
  ...
  def test_accessing_hashes_with_fetch
    ...
    # A: When you want to receive an exception error instead of a nil value for a nonexistant key?
  end
  ...
  def test_changing_hashes
    ...
    # A: a new hash instance needs to be created to compare to, otherwise brakcets treated like a block.
  end
