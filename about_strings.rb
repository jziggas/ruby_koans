...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # A: http://stackoverflow.com/questions/4684446/why-is-the-shovel-operator-preferred-over-plus-equals-when-building-a
    # += creates a new object, shovel operator modifies the existing object which is quicker
  end
