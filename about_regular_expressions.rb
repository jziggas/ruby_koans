...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # A: it will only fail if you have something before or after it that doesn't match
  ...
  def test_variables_can_also_be_used_to_access_captures
    ...
    # http://stackoverflow.com/questions/12945779/ruby-koans-regex-parentheses-capture-matched-content
    assert_equal "Gray", $1
  ...
  # [abcdef] means any character within the brackets will match, same as a|b|c|d|e|f
